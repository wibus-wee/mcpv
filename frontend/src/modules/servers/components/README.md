...
Servers 模块的 UI 组件集合。
覆盖服务器列表、详情面板、编辑表单与运行状态展示。
该目录下组件与 servers 页面共同完成统一的管理体验。
...
- **server-overview-panel.tsx**: 服务器概览信息面板
- **server-runtime-status.tsx**: 运行时状态与指标展示
- **server-tools-panel.tsx**: 服务器工具列表与详情面板
- **servers-data-table.tsx**: 服务器主表格视图
